...
class TronClassPlugin(Star):
    ...
    async def on_any_message(self, event: AstrMessageEvent):
        ...
        if step == "wait_username":
            await self._handle_login_username(event, login_state, text)
        elif step == "wait_password":
            await self._handle_login_password(event, login_state, text)
        elif step == "wait_captcha":
            await self._handle_login_captcha(event, login_state, text)
